...
export default function Footer() {
  return (
    <footer className="bg-charcoal text-cream">
      {/* Main Footer */}
      <div className="max-w-[84rem] mx-auto px-5 sm:px-8 lg:px-10 py-16">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-cream/60 hover:text-sage-light transition-colors duration-300"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item} className="text-sm text-cream/60">
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-cream/60">
              <li className="flex items-start gap-2">
                <svg
                  className="w-4 h-4 mt-0.5 text-sage-light shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
      ...
      <div className="border-t border-white/10">
        <div className="max-w-[84rem] mx-auto px-5 sm:px-8 lg:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
